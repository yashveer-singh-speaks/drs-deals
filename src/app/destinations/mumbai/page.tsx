...
export const metadata: Metadata = {
    title: 'Mumbai Luxury Resort & Hotel Offers | DRS Deals',
    description: 'Exclusive coastal resort vouchers, luxury dining passes, and weekend getaway memberships.',
};
            ...
            <div className="container">
                <div style={{ maxWidth: '800px', margin: '0 auto 48px auto', textAlign: 'center' }}>
                    ...
                    <h1 className="hero-title" style={{ fontSize: '3rem', marginBottom: '20px' }}>
                        Mumbai &amp; Coastal Experience Offers
                    </h1>
                    <p className="text-body-large text-charcoal-light">
                        Luxury hotel memberships, fine dining passes, and getaway packages across premier destinations.
                    </p>
                </div>
