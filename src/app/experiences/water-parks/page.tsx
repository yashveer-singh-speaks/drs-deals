...
export const metadata: Metadata = {
    title: 'Water Parks & Family Day Passes | DRS Deals',
    description: 'Discounted entry passes to top water parks, amusement parks, snow parks, and cultural theme destinations.',
};

export default function WaterParksExperiencePage() {
    const categoryDeals = getDealsByCategory('water-parks');
            ...
            <div className="container">
                <div style={{ maxWidth: '800px', margin: '0 auto 48px auto', textAlign: 'center' }}>
                    ...
                    <h1 className="hero-title" style={{ fontSize: '3rem', marginBottom: '20px' }}>
                        Water Parks &amp; Theme Destinations
                    </h1>
                    <p className="text-body-large text-charcoal-light">
                        Discover discounted day passes for water parks, snow parks, adventure rides, and cultural theme destinations.
                    </p>
                </div>
                        ...
                        <div key={deal.id} className="bg-white shadow-soft" style={{ borderRadius: '16px', padding: '28px', border: '1px solid var(--color-stone)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            <div>
                                ...
                                <div style={{ padding: '12px 16px', background: 'var(--color-ivory)', borderRadius: '10px', border: '1px solid var(--color-stone)', marginBottom: '20px' }}>
                                    <div style={{ fontSize: '0.75rem', color: 'var(--color-charcoal-light)', textTransform: 'uppercase' }}>Special Rate</div>
